...
void Triangle::textureLookup(double alpha, double beta, double gamma, const Vector &intersection,
                             Color &color) const
{
...
Quadric::Quadric(const Vector &center, double a2, double b2, double c2, double d2, double maxOnAxis,
...
Sphere::Sphere(const Vector &center, double radius, enum Color::Surface surface,
               double indexOfRefraction, const Color &color)
{
    mOrigin            = center;
    mRadius            = radius;
...
SphereVolume::SphereVolume(const Vector &origin, double radius, double density, Color &color)
